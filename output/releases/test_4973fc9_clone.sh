...
release_code="4973fc9"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_4973fc9.tar.gz"
expected_sha="cf91e2a0997357eada951b06a73632e2046e9a24cca0db8dd3e793b377bc0f74"
...
test_database="hongyijig_sseries_test_4973fc9"
...
if test_database != "hongyijig_sseries_test_4973fc9":
...
grep -q "'version': '19.0.3.16.0'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
...
grep -q "0 failed, 0 error(s) of 173 tests" "${test_log}"
...
if module.installed_version != "19.0.3.16.0":
...
print(
    "SSERIES_WORKFLOW_PASS version=19.0.3.16.0 templates=22 "
...
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
echo "HJIG_CLONE_TEST_PASS release=${release_code} tests=173 failures=0 errors=0 production_untouched=true"
