...
test_database="hongyijig_sseries_test_96de520"
...
if test_database != "hongyijig_sseries_test_96de520":
...
grep -q "0 failed, 0 error(s) of 168 tests" "${test_log}"
...
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
echo "HJIG_CLONE_TEST_PASS release=${release_code} tests=168 failures=0 errors=0 production_untouched=true"
