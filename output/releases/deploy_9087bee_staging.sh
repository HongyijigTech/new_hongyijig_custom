...
release_code="9087bee"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_9087bee.tar.gz"
expected_sha="e7645ef17ead70beb7e3b028aea9ca54cb636fbccdbf6f7d2c8730625acd7109"
expected_active_source_sha="0f26c675292833dce134707182f3b42f99c7be36affa3c132d4fac097a556117"
...
# 19.0.3.22.5 file-level replacement.  The full source-tree digest above is
...
grep -q "'version': '19.0.3.22.5'" "${active_module}/__manifest__.py"
...
grep -q "'version': '19.0.3.27.0'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
printf '%s  %s\n' \
...
if module.installed_version != "19.0.3.27.0":
...
print(
    "STAGING_SSERIES_AUTHORITY_PASS version=19.0.3.27.0 templates=24 activation_records=13 "
...
grep -q "'version': '19.0.3.27.0'" "${active_module}/__manifest__.py"
sudo -n /usr/bin/systemctl start odoo.service
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
test "$(systemctl is-active clamav-daemon.service)" = "active"
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.27.0 rollback=${rollback_root} http=${http_code} production=untouched"
