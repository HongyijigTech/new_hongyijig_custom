...
release_code="0dc3835"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_0dc3835.tar.gz"
expected_sha="883bbe94b8384ee3f0c246117384c0a7cee80ca60f5e37e1e2d341dd4393c6f1"
expected_active_source_sha="c9663b780e06d75c504e17abcc99b4a40c9cd274dcf52000910f65272e4229bc"
...
grep -q "'version': '19.0.3.24.0'" "${active_module}/__manifest__.py"
...
grep -q "'version': '19.0.3.25.0'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
printf '%s  %s\n' \
...
if module.installed_version != "19.0.3.25.0":
...
print(
    "STAGING_SSERIES_AUTHORITY_PASS version=19.0.3.25.0 templates=24 activation_records=13 "
...
grep -q "'version': '19.0.3.25.0'" "${active_module}/__manifest__.py"
sudo -n /usr/bin/systemctl start odoo.service
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
test "$(systemctl is-active clamav-daemon.service)" = "active"
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.25.0 rollback=${rollback_root} http=${http_code} production=untouched"
