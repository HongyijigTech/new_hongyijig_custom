...
release_code="41cf6e2"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_41cf6e2.tar.gz"
expected_sha="468cb49c911b8a7da5f759fc534ef29086b3f212f4e6cfda90beaed614632f96"
...
test_database="hongyijig_sseries_test_41cf6e2"
...
grep -q "'version': '19.0.3.11.0'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
...
if test_database != "hongyijig_sseries_test_41cf6e2":
...
grep -q "0 failed, 0 error(s) of 166 tests" "${test_log}"
...
if module.installed_version != "19.0.3.11.0":
...
print("SSERIES_WORKFLOW_PASS version=19.0.3.11.0 templates=22 cases=0 production_untouched=true")
env.cr.rollback()
PY
...
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
echo "HJIG_CLONE_TEST_PASS release=${release_code} tests=166 failures=0 errors=0 production_untouched=true"
