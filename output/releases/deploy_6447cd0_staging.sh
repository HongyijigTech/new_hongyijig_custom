...
expected_active_source_sha="308406bf57114610e34ade4d730ae868aa77a58a3b667e850ce064ee04051c08"
...
grep -q "0 failed, 0 error(s) of 195 tests" "/home/hongyi-jig-erp/releases/work/${release_code}/post_install_tests.log"
grep -q "SSERIES_WORKFLOW_PASS" "/home/hongyi-jig-erp/releases/work/${release_code}/sseries_validation.log"
grep -q "'version': '19.0.3.19.2'" "${active_module}/__manifest__.py"
...
print(
    "STAGING_SSERIES_WORKFLOW_PASS version=19.0.3.20.1 "
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.20.1 rollback=${rollback_root} http=${http_code} production=untouched"
