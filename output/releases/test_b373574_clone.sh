...
release_code="b373574"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_b373574.tar.gz"
expected_sha="bb92a6760a309ffba945ba331736d6bc58328a87b4996b3a16e34278229979ad"
...
test_database="hongyijig_sseries_test_b373574"
...
if test_database != "hongyijig_sseries_test_b373574":
...
grep -q "0 failed, 0 error(s) of 196 tests" "${test_log}"
...
print(
    "SSERIES_WORKFLOW_PASS version=19.0.3.20.2 templates=22 "
...
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
echo "HJIG_CLONE_TEST_PASS release=${release_code} tests=196 failures=0 errors=0 production_untouched=true"
