...
release_code="e354c17"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_e354c17.tar.gz"
expected_sha="a9b499b3da617d57db6e78af077c64f9508c7a05859adfa5aefd876bab05f341"
...
test_database="hongyijig_sseries_test_e354c17"
...
if test_database != "hongyijig_sseries_test_e354c17":
...
grep -q "0 failed, 0 error(s) of 188 tests" "${test_log}"
...
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
echo "HJIG_CLONE_TEST_PASS release=${release_code} tests=188 failures=0 errors=0 production_untouched=true"
