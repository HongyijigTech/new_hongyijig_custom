...
test_database="hongyijig_sseries_test_9b0fddd"
...
if test_database != "hongyijig_sseries_test_9b0fddd":
...
grep -q "0 failed, 0 error(s) of 178 tests" "${test_log}"
...
print(
    "SSERIES_WORKFLOW_PASS version=19.0.3.17.0 templates=22 "
...
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
echo "HJIG_CLONE_TEST_PASS release=${release_code} tests=178 failures=0 errors=0 production_untouched=true"
