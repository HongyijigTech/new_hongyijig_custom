...
test_database="hongyijig_sseries_test_bbe508e"
...
if test_database != "hongyijig_sseries_test_bbe508e":
...
print(
    "SSERIES_AUTHORITY_PASS version=19.0.3.24.0 templates=24 activation_records=13 "
