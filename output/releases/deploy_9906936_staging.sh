...
release_code="9906936"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_9906936.tar.gz"
expected_sha="379ee6f4b12f9881cb79c2df1969bcb6edfd87264c936d81a7088bb84cef1e77"
expected_active_source_sha="b18e26fcdf92b09af20149f03f6f51ddaf73cc190ef0138560a74a0231f079f8"
...
grep -q "0 failed, 0 error(s) of 196 tests" "/home/hongyi-jig-erp/releases/work/${release_code}/post_install_tests.log"
grep -q "SSERIES_WORKFLOW_PASS" "/home/hongyi-jig-erp/releases/work/${release_code}/sseries_validation.log"
grep -q "'version': '19.0.3.20.1'" "${active_module}/__manifest__.py"
...
grep -q "'version': '19.0.3.20.2'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
...
if module.installed_version != "19.0.3.20.2":
    raise RuntimeError(f"Unexpected installed version: {module.installed_version}")
print(
    "STAGING_SSERIES_WORKFLOW_PASS version=19.0.3.20.2 "
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.20.2 rollback=${rollback_root} http=${http_code} production=untouched"
