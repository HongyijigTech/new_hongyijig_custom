...
test_database="hongyijig_sseries_test_0c6aeae"
...
if test_database != "hongyijig_sseries_test_0c6aeae":
...
print(
    "SSERIES_AUTHORITY_PASS version=19.0.3.22.0 templates=24 activation_records=13 "
