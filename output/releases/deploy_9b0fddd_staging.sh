...
release_code="9b0fddd"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_9b0fddd.tar.gz"
expected_sha="12ba7afc3c9924b7a349a9589364a1fcbfd01196c8505197660bea8dc6bdf75d"
expected_active_source_sha="a53ac5b0c8f3108e3de1f2e0f65f183bcf0762ddafa622d4a686d70521913318"
...
grep -q "0 failed, 0 error(s) of 178 tests" "/home/hongyi-jig-erp/releases/work/${release_code}/post_install_tests.log"
grep -q "SSERIES_WORKFLOW_PASS" "/home/hongyi-jig-erp/releases/work/${release_code}/sseries_validation.log"
grep -q "'version': '19.0.3.16.0'" "${active_module}/__manifest__.py"
...
grep -q "'version': '19.0.3.17.0'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
...
if module.installed_version != "19.0.3.17.0":
    raise RuntimeError(f"Unexpected installed version: {module.installed_version}")
print(
    "STAGING_SSERIES_WORKFLOW_PASS version=19.0.3.17.0 "
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.17.0 rollback=${rollback_root} http=${http_code} production=untouched"
