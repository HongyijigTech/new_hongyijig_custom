...
release_code="72e751f"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_72e751f.tar.gz"
expected_sha="4ccdd3acd911c52c6923ad8836ff1ea7af4ea275a09afdd271e45e6245cf67c6"
expected_active_source_sha="417506b26909244565464b6aef6a9f51975d0fcba595540d2e3af0e9eb18960a"
...
grep -q "0 failed, 0 error(s) of 170 tests" "/home/hongyi-jig-erp/releases/work/${release_code}/post_install_tests.log"
grep -q "SSERIES_WORKFLOW_PASS" "/home/hongyi-jig-erp/releases/work/${release_code}/sseries_validation.log"
grep -q "'version': '19.0.3.13.0'" "${active_module}/__manifest__.py"
...
grep -q "'version': '19.0.3.14.0'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
...
if module.installed_version != "19.0.3.14.0":
    raise RuntimeError(f"Unexpected installed version: {module.installed_version}")
print(
    "STAGING_SSERIES_WORKFLOW_PASS version=19.0.3.14.0 "
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.14.0 rollback=${rollback_root} http=${http_code} production=untouched"
