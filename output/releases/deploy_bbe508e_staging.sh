...
release_code="bbe508e"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_bbe508e.tar.gz"
expected_sha="3aa7ef69be28d761f596b5bf1e41e07c3f6dd35bd34e9f451e7a5206e0918025"
expected_active_source_sha="4155e7f3bd989822baaa1d67bae13953137cf63c4e544e6fa4bddae1947ad6f3"
...
grep -q "0 failed, 0 error(s) of 203 tests" "/home/hongyi-jig-erp/releases/work/${release_code}/post_install_tests.log"
grep -q "SSERIES_AUTHORITY_PASS" "/home/hongyi-jig-erp/releases/work/${release_code}/sseries_validation.log"
grep -q "'version': '19.0.3.23.0'" "${active_module}/__manifest__.py"
...
grep -q "'version': '19.0.3.24.0'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
...
if module.installed_version != "19.0.3.24.0":
...
print(
    "STAGING_SSERIES_AUTHORITY_PASS version=19.0.3.24.0 templates=24 activation_records=13 "
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.24.0 rollback=${rollback_root} http=${http_code} production=untouched"
