...
test_database="hongyijig_sseries_test_b21a2ce"
...
if test_database != "hongyijig_sseries_test_b21a2ce":
...
grep -q "0 failed, 0 error(s) of 198 tests" "${test_log}"
...
print(
    "SSERIES_WORKFLOW_PASS version=19.0.3.21.0 templates=22 "
...
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
echo "HJIG_CLONE_TEST_PASS release=${release_code} tests=198 failures=0 errors=0 production_untouched=true"
