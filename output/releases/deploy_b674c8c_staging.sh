...
release_code="b674c8c"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_b674c8c.tar.gz"
expected_sha="38c14876d92a991e36d46b9855c0401d2c92090acc3c9bbab9767df0f909242a"
expected_active_source_sha="d0028ccd9ba7a19d2c9e24f1af68894c151da4744cdb7635a64aba03e5dcf334"
...
grep -q "'version': '19.0.3.15.1'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
...
if module.installed_version != "19.0.3.15.1":
    raise RuntimeError(f"Unexpected installed version: {module.installed_version}")
print(
    "STAGING_SSERIES_WORKFLOW_PASS version=19.0.3.15.1 "
...
grep -q "'version': '19.0.3.15.1'" "${active_module}/__manifest__.py"
sudo -n /usr/bin/systemctl start odoo.service
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
http_code="000"
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.15.1 rollback=${rollback_root} http=${http_code} production=untouched"
