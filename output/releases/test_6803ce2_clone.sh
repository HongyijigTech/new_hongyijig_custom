...
release_code="6803ce2"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_6803ce2.tar.gz"
expected_sha="5f66521b6e2a9fb236c16f37a907680bc94e9e597833e002be3a2cbf60dce2c4"
...
test_database="hongyijig_sseries_test_6803ce2"
...
if test_database != "hongyijig_sseries_test_6803ce2":
...
grep -q "'version': '19.0.3.20.0'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
...
grep -q "0 failed, 0 error(s) of 193 tests" "${test_log}"
...
if module.installed_version != "19.0.3.20.0":
...
print(
    "SSERIES_WORKFLOW_PASS version=19.0.3.20.0 templates=22 "
...
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
echo "HJIG_CLONE_TEST_PASS release=${release_code} tests=193 failures=0 errors=0 production_untouched=true"
