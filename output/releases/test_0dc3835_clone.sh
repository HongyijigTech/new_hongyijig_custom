...
test_database="hongyijig_sseries_test_0dc3835"
...
if test_database != "hongyijig_sseries_test_0dc3835":
...
print(
    "SSERIES_AUTHORITY_PASS version=19.0.3.25.0 templates=24 activation_records=13 "
