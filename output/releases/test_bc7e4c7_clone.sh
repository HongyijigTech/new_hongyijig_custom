...
release_code="bc7e4c7"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_bc7e4c7.tar.gz"
expected_sha="c8c6b5583a829f7856a2579f03b377af974daef2e80881ea49dd077703234841"
...
test_database="hongyijig_sseries_test_bc7e4c7"
...
if test_database != "hongyijig_sseries_test_bc7e4c7":
...
grep -q "0 failed, 0 error(s) of 185 tests" "${test_log}"
...
print(
    "SSERIES_WORKFLOW_PASS version=19.0.3.19.0 templates=22 "
...
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
echo "HJIG_CLONE_TEST_PASS release=${release_code} tests=185 failures=0 errors=0 production_untouched=true"
