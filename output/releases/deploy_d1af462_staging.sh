...
release_code="d1af462"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_d1af462.tar.gz"
expected_sha="4534749ed4b51946622e7bb7ddaca7c0f6d47d622d848231b5c93dd9df1184ed"
expected_active_source_sha="9bdb032e3f2e168e3908f9456b317ba6c5f043ab2a0bee1da485e42359fa6803"
...
grep -q "0 failed, 0 error(s) of 184 tests" "/home/hongyi-jig-erp/releases/work/${release_code}/post_install_tests.log"
grep -q "SSERIES_WORKFLOW_PASS" "/home/hongyi-jig-erp/releases/work/${release_code}/sseries_validation.log"
grep -q "'version': '19.0.3.16.2'" "${active_module}/__manifest__.py"
...
grep -q "'version': '19.0.3.18.0'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
...
if module.installed_version != "19.0.3.18.0":
    raise RuntimeError(f"Unexpected installed version: {module.installed_version}")
print(
    "STAGING_SSERIES_WORKFLOW_PASS version=19.0.3.18.0 "
...
grep -q "'version': '19.0.3.18.0'" "${active_module}/__manifest__.py"
sudo -n /usr/bin/systemctl start odoo.service
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
http_code="000"
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.18.0 rollback=${rollback_root} http=${http_code} production=untouched"
