...
release_code="6afd679"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_6afd679.tar.gz"
expected_sha="c15f167dff8655ede23d5c2d1621f2d868717b590421f8a84e96b17fd233303d"
expected_active_source_sha="2ead8fb895c44945ca71ac73c3099a7156c04ec4b8a6c85ca8da8263dda74eee"
...
grep -q "0 failed, 0 error(s) of 202 tests" "/home/hongyi-jig-erp/releases/work/${release_code}/post_install_tests.log"
grep -q "SSERIES_AUTHORITY_PASS" "/home/hongyi-jig-erp/releases/work/${release_code}/sseries_validation.log"
grep -q "'version': '19.0.3.22.1'" "${active_module}/__manifest__.py"
...
print(
    "STAGING_SSERIES_AUTHORITY_PASS version=19.0.3.23.0 templates=24 activation_records=13 "
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.23.0 rollback=${rollback_root} http=${http_code} production=untouched"
