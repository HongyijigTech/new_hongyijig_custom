...
release_code="77d4ea9"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_77d4ea9.tar.gz"
expected_sha="fad881ec996cfbeceab28310756ca8cc11f8ee314e1f7d208cd4bc1c1e963c38"
expected_active_source_sha="4b67204e39e77bd9cc214407431599e2d34e612025132a2ae04f9698127533a1"
...
grep -q "0 failed, 0 error(s) of 169 tests" "/home/hongyi-jig-erp/releases/work/${release_code}/post_install_tests.log"
...
grep -q "'version': '19.0.3.13.0'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
...
if module.installed_version != "19.0.3.13.0":
    raise RuntimeError(f"Unexpected installed version: {module.installed_version}")
print(
    "STAGING_SSERIES_WORKFLOW_PASS version=19.0.3.13.0 "
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.13.0 rollback=${rollback_root} http=${http_code} production=untouched"
