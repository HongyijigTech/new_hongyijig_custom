...
test_database="hongyijig_sseries_test_d1af462"
...
if test_database != "hongyijig_sseries_test_d1af462":
...
grep -q "0 failed, 0 error(s) of 184 tests" "${test_log}"
...
print(
    "SSERIES_WORKFLOW_PASS version=19.0.3.18.0 templates=22 "
...
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
echo "HJIG_CLONE_TEST_PASS release=${release_code} tests=184 failures=0 errors=0 production_untouched=true"
