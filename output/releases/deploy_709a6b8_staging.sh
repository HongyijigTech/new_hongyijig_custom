...
release_code="709a6b8"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_709a6b8.tar.gz"
expected_sha="7145582d1ff9e724a3a9e8f4e045cb0b99f6f62888253071f792a98783cbdd2b"
expected_active_source_sha="63b4ee2c22054923fe1e34a88f6f31b52d92afe870ea4838f9c032e2983bf95d"
...
grep -q "0 failed, 0 error(s) of 167 tests" "/home/hongyi-jig-erp/releases/work/${release_code}/post_install_tests.log"
grep -q "SSERIES_WORKFLOW_PASS" "/home/hongyi-jig-erp/releases/work/${release_code}/sseries_validation.log"
grep -q "'version': '19.0.3.9.3'" "${active_module}/__manifest__.py"
...
grep -q "'version': '19.0.3.11.4'" "${candidate_root}/new_hongyijig_custom/__manifest__.py"
...
if module.installed_version != "19.0.3.11.4":
    raise RuntimeError(f"Unexpected installed version: {module.installed_version}")
print(
    "STAGING_SSERIES_WORKFLOW_PASS version=19.0.3.11.4 "
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.11.4 rollback=${rollback_root} http=${http_code} production=untouched"
