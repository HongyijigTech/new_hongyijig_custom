...
test_database="hongyijig_sseries_test_7ed60a2"
...
if test_database != "hongyijig_sseries_test_7ed60a2":
...
grep -q "0 failed, 0 error(s) of 181 tests" "${test_log}"
...
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
echo "HJIG_CLONE_TEST_PASS release=${release_code} tests=181 failures=0 errors=0 production_untouched=true"
