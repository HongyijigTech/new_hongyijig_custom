...
test_database="hongyijig_sseries_test_709a6b8"
...
if test_database != "hongyijig_sseries_test_709a6b8":
...
print("SSERIES_WORKFLOW_PASS version=19.0.3.11.4 templates=22 cases=0 bseries_preserved=true production_untouched=true")
env.cr.rollback()
PY
