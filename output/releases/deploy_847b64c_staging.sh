...
release_code="847b64c"
active_module="/home/hongyi-jig-erp/odoo/staging_overrides/new_hongyijig_custom"
package_path="/home/hongyi-jig-erp/releases/incoming/Hongyi_Odoo_SSeries_847b64c.tar.gz"
expected_sha="ef2bf4acefea6a2b9a231aeacaf0ea2412031acc25a4deca1ecf5e89ce784b7e"
expected_active_source_sha="80ca5d57ab1d3e1d8703a04ebbd086175b1d9d9f5d4ad07c1f9df0092b511534"
...
# 19.0.3.22.3 file-level replacement.  The full source-tree digest above is
...
grep -q "'version': '19.0.3.22.3'" "${active_module}/__manifest__.py"
...
print(
    "STAGING_SSERIES_AUTHORITY_PASS version=19.0.3.26.0 templates=24 activation_records=13 "
...
grep -q "'version': '19.0.3.26.0'" "${active_module}/__manifest__.py"
sudo -n /usr/bin/systemctl start odoo.service
test "$(systemctl is-active odoo.service)" = "active"
test "$(systemctl is-active odoo-production.service)" = "active"
test "$(systemctl is-active clamav-daemon.service)" = "active"
...
deployment_started=0
trap - ERR
echo "HJIG_STAGING_UPGRADE_SUCCESS release=${release_code} version=19.0.3.26.0 rollback=${rollback_root} http=${http_code} production=untouched"
